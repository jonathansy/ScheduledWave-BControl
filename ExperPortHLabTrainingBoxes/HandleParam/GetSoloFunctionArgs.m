...
%
% ** IF this function is called with first parameter 'arglist', ** it then
...
% $Id: GetSoloFunctionArgs.m,v 1.7 2006/02/01 05:18:09 carlos Exp $
   ...
   if strcmp('all_read_only', 'on'),
      globalro_args = [global_rw_args ; global_ro_args];
      global_rw_args = {};
   end;
