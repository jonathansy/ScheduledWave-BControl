...
% Version history
% 091905        CDB         Initial write
% 092105        SSP
%   1. Added 'HEADER' and 'SUBHEADER' controls
%   2. TooltipString appends param_name to its start
% 092405        SSP         Switched to Carlos' 092305 version (this file)
% and added changes made above

% $Id: SoloParam.m,v 1.19 2006/10/13 02:51:36 carlos Exp $ 
...
function [s] = SoloParam(varargin)
   ...
   if nargin==1 & isa(varargin{1}, 'SoloParam'),
      ...
      if iscell(value), value_for_struct = {value}; 
      else              value_for_struct = value;
      end; 
      s = struct( ...
