...
%                     AOLine1 = 1; AOLine2 = 2;
%                     loopBool = 0;
%                     machine = SetScheduledWaves(machine, ID1, AOLine1, loopBool, schedWv);
%                     machine = SetScheduledWaves(machine, ID2, AOLine2, loopBool, schedWv);
...
%                     machine = SetStateProgram(machine,'matrix',value,'globals',G,'tickfunc','tick_func');
%                     machine = SetStateProgram(machine,'matrix',value,'globals',G,'tickfunc','tick_func','threshfunc','thresh_func');
