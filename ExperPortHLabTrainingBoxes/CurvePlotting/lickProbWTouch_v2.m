...
% v2 -Cteated 2015-04-21
% Change log: now outputs 4x4 matrix: raw number of licks vs number of trials, top of matrix is with touch, bottom is without. 
function [Probabilities] = lickProbWTouch_v2(arrayName, trialType)
...
Probabilities(1,:) = lickTrialSum;
Probabilities(2,:) = allTrialSum; 
end 
