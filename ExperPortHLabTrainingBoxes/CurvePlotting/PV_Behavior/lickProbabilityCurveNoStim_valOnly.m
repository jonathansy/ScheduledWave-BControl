...
function [lickPercent] = lickProbabilityCurveNoStim_valOnly(dataInput, stimDirname, bins, onFilter, offFilter)
...
sizeStimInfo = numel(stimIndex); 
        ...
        motorPositionDat = motorPositionDat((onFilter+tDisp):(offFilter+tDisp));
        ...
        lickingArray = lickingArray((onFilter+tDisp):(offFilter+tDisp)); 
