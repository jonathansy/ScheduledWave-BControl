%% Creates plot of touch probability vs. pole position using mouse whisking data
...
motorPositionDat = cell2mat(saved_history.motors_section_motor_position); %Note: I coded this at home from memory, please check if correct matrix spelling 
...
lickProb = zeros(1,18);
for motorPosIndex = motorPosBins; %Loop command for each bin 
    motorRangeStart = motorPosIndex - 10000; % Subtract 10,000 so as to start at 0 and go by increments of 10,000
    motorRangeEnd = motorPosIndex; 
