 ...
 *********************************************************************************/
const double VOLTAGE_X_GALVO = -2.5;  
const double VOLTAGE_Y_GALVO = 0; 
/* s1: x=-3, y=0.4
/*const double VOLTAGE_AOM_473 = 0.075;*/ /*0.075 or 5.0*/ 
/*const double VOLTAGE_AOM_473 = -0.120; /* Changed 13sep11 */ 
const double VOLTAGE_AOM_473 = 0; /* Changed 13sep11 */ 
...
const unsigned aom_473_ao_chan = 1; /* Analog output channel for AOM for 473 nm laser. */
const unsigned aom_594_ao_chan = 1; /* Analog output channel for AOM for 594 nm laser. */
