...
switch action
    case 'init',
        ...
        MenuParam(obj, 'WaterValveDelay', {'0.2','0.4','random'}, '0.4', x, y, 'TooltipString', ...
        ...
        next_row(y);
        MenuParam(obj, 'pole_delay', {'0.5', '1', '1.5','2','3','random'},'1.5',x,y);
        next_row(y);
        MenuParam(obj, 'SamplingPeriodTime', {'0.2','0.5','0.75','1','1.25','1.5','1.75','2','2.5','3'},'1.5', x, y);
        next_row(y);
...
%         end
        ...
        SoloFunctionAddVars('make_and_upload_state_matrix', 'ro_args', ...
            {'ExtraITIOnError','SamplingPeriodTime','WaterValveDelay','pole_delay'});
