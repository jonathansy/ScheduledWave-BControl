...
%            end
           ...
           stm = [stm ;
               ...
               b     b    b+11 .01        cmid+etid  0  ; ... % trigger camera and EPHUS; 1 ms later jump to state that eevntually goes to 101 to give trial num bit code.
               ...
               b+3   b+3  b+4  wvtm      wvid       0  ; ... % reward tone + water - HIT
               b+4   b+4  35   2.5+2*wvtm  0          0  ; ... % Drinking time. Animal can drink also in ITI.
               b+9   b+5  35  eiti       0          0 ; ... % incorrect lick, extra ITI - FALSE ALARM
               b+6   b+6  35  1.5       0          0  ; ... % didn't lick before timeout - MISS
               b+7   b+7  35  1.5       0          0  ; ... % correct nogo.
               b+8   b+8  35  1.5       0          0  ; ... % 
               ...
               b+11  b+11 101  1         0          0 ...  %  relax state after ephus trigger is delivered so that scanimage starts - scanimage likes down triger(WHY???) 
               ];
