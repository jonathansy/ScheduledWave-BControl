   ...
   switch SessionType % determined by SessionTypeSection
      ...
      case 'Water-Valve-Calibration'
       ...
       case 'Beam-Break-Indicator'
           stm = [stm ;
                    b+1   b  b+1  b  b+2 b     35  999  0      0  ; ...
                    b+1   b  b+1  b  b+2 b     35  999  LEDid  0  ; ...
                    b+1   b  b+1  b  b+2 b     35  999  secLEDid  0  ; ...
                    ];
...
%            end
           ...
           stm = [stm ;
               %Cin Cout TrmOn TrmOff PolOn PolOff Tup  Tim   Dou Aou (Dou is bitmask format)
               b     b    b     b       b       b  101 .01     etid   0  ; ... % trigger camera and EPHUS; 10 ms later jump to state 101 to give trial num bit code.
               b+1   b+1  b+1   b+1     b+1   b+1  b+10 sptm   pvid   0  ; ... % whisker sensing state. sptm should be greater than 0.2 for the pole to descend
               ...
               b+4   b+4  b+4   b+4     b+4   b+4  35  0.1     0      0  ; ... % Drinking time. Animal can drink also in ITI.
               ...
               b+10  b+10 b+10  b+10    b+10  b+10 b+2  prmv   0      0 ...  %  pole remove state. 
               ];
