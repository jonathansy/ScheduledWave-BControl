...
function [x, y] = SessionTypeSection(obj, action, x, y)
   ...
   switch action
    ...
    case 'init',   % ------------ CASE INIT ----------------
      ...
      MenuParam(obj, 'SessionType', {'Water-Valve-Calibration',...
          'Beam-Break-Indicator','Licking','Discrim',...
          'Laser-473nm-On-Min','Laser-473nm-On-Max','LaserTest','Pole-up-pole-down' },...
          'Beam-Break-Indicator', x, y);
