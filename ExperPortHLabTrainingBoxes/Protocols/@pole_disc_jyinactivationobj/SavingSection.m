...
%       set_callback(loaddata, {mfilename, 'loaddata'}); next_row(y);     
      ...
      EditParam(obj, 'MouseName', 'ANMXXXX', x, y); next_row(y, 1.5);
      EditParam(obj, 'Weight', 'Not recorded', x, y); next_row(y, 1.5);
      EditParam(obj, 'WeightAfterExp', 'Not recorded', x, y); next_row(y, 1.5);
%       MenuParam(obj, 'HeadFixed', {'Fixed w/o anesthesia','Fixed after anesthesia','Not fixed'},'Fixed after anesthesia', x, y); next_row(y, 1.5);
%       MenuParam(obj, 'Lighting', {'IR Security Cam','Diffuse 940nm for Security Cam','940nm High-speed Imaging','White light','Totally Dark'},'Diffuse 940nm for Security Cam', x, y); next_row(y, 1.5);
%       MenuParam(obj, 'Punishment', {'None','ExtraITI','60 psi',...
%           '55 psi','50 psi','45 psi','40 psi','35 psi','30 psi','25 psi',...
%           '20 psi','15 psi','10 psi'},'10 psi', x, y); next_row(y, 1.5);  
%       MenuParam(obj, 'WhiskerSet', {'Full','Row D only','D2 only','C2 only','None','Row C only',...
%           'Row D subset','Row C subset'},'Full', x, y); next_row(y, 1.5);
