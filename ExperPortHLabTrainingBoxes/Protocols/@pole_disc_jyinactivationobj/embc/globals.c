...
const unsigned aom_473_chan = 7; /* Analog output channel for AOM for 473 nm laser. */
const unsigned aom_594_chan = 7; /* Analog output channel for AOM for 594 nm laser. */
