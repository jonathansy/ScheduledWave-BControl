...
%         next_row(y);
        ...
        NumeditParam(obj, 'go1',6e4, x, y, 'position', [x y 50 20], 'label','', 'labelfraction', 0.05);
        NumeditParam(obj, 'go2',3e4, x, y, 'position', [x+50 y 50 20],'label','', 'labelfraction', 0.05); 
        NumeditParam(obj, 'go3',9e4, x, y, 'position', [x+100 y 50 20],'label','',  'labelfraction', 0.05);
        NumeditParam(obj, 'go4', 0e4, x, y, 'position', [x+150 y 50 20],'label','',  'labelfraction',0.05);
        ...
        next_row(y);
        NumeditParam(obj, 'nogo_position', 170000, x, y, 'label', ...
            'No-go position','TooltipString','No-go trial position in microsteps.');
        
        next_row(y);
        NumeditParam(obj, 'go_position', 50000, x, y, 'label', ...
