...
%  Also handles fraction of trials on which animal gets puff.
%
% PARAMETERS:
% -----------
%
...
function [x, y] = ValvesSection(obj, action, x, y)
   ...
   switch action
    case 'init',
      ...
      EditParam(obj, 'AirpuffFrac', valves_properties.airpuff_frac, x, y);  next_row(y);
      SoloFunctionAddVars('make_and_upload_state_matrix', 'ro_args', {'AirpuffFrac'});
